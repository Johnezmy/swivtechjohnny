      ...
      <div class="col-sm-10">
        ...
        <div class="row">
          <div class="col-md-12">
              ...
              <hr>
                <h1><small>TOP RATED PRODUCTS</small></h1>
...
<?php
 $query = mysqli_query($db, "SELECT * FROM top_rated ORDER BY id DESC ");
...
<tr>
                   ...
                   <td><?php echo $p_price; ?></td>
                    ...
                    <td><b><a href='delete_rated.php?ID=<?php echo $m_id; ?>'>Delete</a></b></td>
                 </tr>
