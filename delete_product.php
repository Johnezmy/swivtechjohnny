...
<h6 style="text-align:center;">Are You Sure You Want To Delete This Product?</h6>
    <br><br>
   ...
   <br><br>
    ...
    <br><br>
    <button class="btn btn-primary btn-lg" style="border-radius: 0px; text-color: white"><a href='submit_delete_product.php?ID=<?php echo $id; ?>'>Delete Event</a><i class="fa fa-arrow-right"></i></button>
